...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    organization: 'YDPay',
    image: '/speakers/07-chike-okonkwo-512.webp',
    bio: [
  ...
  {
    id: 17,
    slug: 'adeyemi-ademosu',
    name: 'Adeyemi Ademosu',
    role: 'Head of Risk Management & Internal Control',
    organization: 'Quidax',
    image: '/speakers/17-adeyemi-ademosu-512.webp',
    bio: [
      'Adeyemi Ademosu is the Head of Risk Management and Internal Control at Quidax, Nigeria\u2019s first cryptocurrency exchange licensed by the Securities and Exchange Commission.',
      'With extensive experience spanning banking and fintech, he has led high-performing risk management teams focused on strengthening operational resilience, governance, and regulatory compliance. His expertise covers enterprise and operational risk management, particularly risks arising from systems, people, processes, and external events within fast-evolving financial ecosystems.',
    ],
  },
  {
    id: 18,
